...
// STRICTLY use environment variable - no hardcoded credentials!
const MONGODB_URI = process.env.MONGODB_URI;

if (!MONGODB_URI) {
    console.error("FATAL ERROR: MONGODB_URI environment variable is missing.");
    console.error("Please add MONGODB_URI in your Render.com Environment Variables.");
...
// App Router (Handles both GET and POST securely)
